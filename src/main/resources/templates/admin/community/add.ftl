...
<title>${siteName!""}|地址管理-添加地址</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加地址</h4></div>
              <div class="card-body">
                <form id="user-add-form" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="street" name="street"
                           value="" placeholder="请输入街道名或者镇名" tips="请输入街道名或者镇名" />
                  </div>
                    <div class="input-group m-b-10">
                        <span class="input-group-addon">具体地址/社区</span>
                        <input type="text" class="form-control required" id="name" name="name"
                               value="" placeholder="请输入你的具体地址" tips="请输入你的具体地址" />
                    </div>
...
$(document).ready(function(){
	...
	$("#add-form-submit-btn").click(function(){
		...
		var province = $("#add-province").val().trim();
		var city = $("#add-city").val().trim();
		var area = $("#add-area").val().trim();
